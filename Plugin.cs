    ...
    public class Plugin : BaseUnityPlugin
    {
        private void Update() { 
            ...
            foreach (NetworkPlayer player in networkPlayers) {
                ...
                object[] instantiationData = player.mPhotonView.instantiationData;
                if (instantiationData == null || instantiationData.Length == 0) { continue; } // sanity check to avoid possible errors
